...
test.describe('Update skill logo', () => {
  test('should response updated skill logo with status "success" when request PATCH /skills/:key/actions/logo', async ({
    request,
  }) => {
    await request.post(apiUrlPrefix + '/skills',
      {
...
test.describe('Update skill tags', () => {
  test('should response updated skill tags with status "success" when request PATCH /skills/:key/actions/tags', async ({
    request,
  }) => {
    await request.post(apiUrlPrefix + '/skills',
      {
  ...
  test('should response status "error" with message "not be able to update skill tags" when request PATCH /skills/:key/actions/tags', async ({
    request,
  }) => {
    const updateResponse = await request.patch(apiUrlPrefix + '/skills/python/actions/tags',
      {
...
test.describe('Delete skill', () => {
  test('should response status "success" with message "Skill deleted" when request DELETE /skills/:key', async ({
    request,
  }) => {
    await request.post(apiUrlPrefix + '/skills',
      {
